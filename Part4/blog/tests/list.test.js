...
describe('favorite blog', () => {
  ...
  test('when list has no blogs, no blogs are returned', () => {
    const result = listHelper.favoriteBlog(listWithNoBlogs)
    expect(result).toBe(0)
  })

  test('when list has only one blog, that one blog is returned', () => {
  ...
  test('when list has only one blog and that blog has zero likes, that one blog is returned', () => {
    const result = listHelper.favoriteBlog(listWithOneBlogZeroLikes)
    expect(result).toEqual({
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
      author: 'Edsger W. Dijkstra',
  ...
  test('when list has six blogs, the blog with the highest likes is returned', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog and that blog has zero likes, that one blog is returned', () => {
    const result = listHelper.mostBlogs(listWithOneBlogZeroLikes)
    expect(result).toEqual({ author: 'Edsger W. Dijkstra', blogs: 1 })
  })

  test('when list has six blogs, the name with the most blogs is returned', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog and that blog has zero likes, that one blog is returned', () => {
    const result = listHelper.mostLikes(listWithOneBlogZeroLikes)
